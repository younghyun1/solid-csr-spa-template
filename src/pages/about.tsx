...
export default function About() {
  return (
    <section class="bg-sky-50 dark:bg-black text-gray-700 dark:text-gray-100 p-8 min-h-screen transition-colors duration-90">
      ...
      <p class="mb-4">
        I am a software engineer with experience in integrating sensors, meters,
        appliances, and other systems into construction engineering software
        services using <b>Rust</b>, <b>Axum</b>, <b>postgreSQL</b>, and{" "}
        <b>AWS</b>. My past efforts have included researching and applying
        caching strategies for a latency-sensitive BEMS service dealing with
        large amounts of real-time sensor data, deployed internationally.
        Experienced in managing and cutting down cloud infrastructure costs in
      ...
      <p class="mb-6">
        Always aspiring towards system programming expertise and the upholding
        of open-source ethics as well as the right of STEM workers everywhere in
        the world.
      </p>
      ...
      <ul class="mb-4 list-disc list-inside">
        <li>
          <b>Company:</b> Suggestions welcome!
        </li>
        <li>
          <b>Role:</b> Backend Software Engineer
        </li>
        <li>
        ...
        <li>
          <b>Other Experiences:</b> soldiering, interpretation, translation,
          logistics, tutoring/lecturing, photography
        </li>
      </ul>
      ...
      <ul class="mb-4 list-disc list-inside">
        <li>
          <b>Programming Languages:</b> Rust, C, C++, Java, Python, x86
          Assembly, JS, TS
        </li>
        <li>
          <b>Languages:</b> Korean (Native), English (C2),
          French/German/Spanish/Mandarin (Rudimentary)
        </li>
        <li>
          <b>Frameworks:</b> Axum, Express, Spring
        </li>
        <li>
          <b>Platforms:</b> AWS, GCP, Oracle Cloud, Naver Cloud
        </li>
        <li>
          <b>DBs:</b> PostgreSQL, MySQL, SQLite, Redis...and the good old in-RAM
          lookup table.
        </li>
      </ul>
      ...
      <ul class="mb-4 list-disc list-inside">
        ...
        <li>
          <b>Effective Concurrency through Asynchronity and Parallelism</b>
        </li>
        <li>
          <b>On-Prem Infrastructure</b>
        </li>
